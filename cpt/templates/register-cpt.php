  ...
  function register_cpt($name, $singular, $opts) {
    ...
    add_action('init', function() use ($a) {
      ...
      $args = array(
        ...
        'taxonomies'            => isset($opts['taxonomies']) ? array( $opts['taxonomies'] ) : '',
        'supports'              => array('thumbnail', 'title', 'comments', 'editor'),
        'menu_icon'             => isset($opts['icon']) ? $opts['icon'] : 'dashicons-text-page',
        'hierarchical'          => true,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
        'menu_position'         => isset($opts['menu_position']) ? $opts['menu_position'] : 1,
